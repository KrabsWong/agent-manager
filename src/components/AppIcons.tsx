...
const CodebuddyIconSVG = ({ size = 16, className = '' }: { size?: number; className?: string }) => (
  <svg
    ...
    className={className}
  >
    <g clipPath="url(#clip0_codebuddy)">
      {/* Background - transparent for monochrome style */}
      <rect width="40" height="40" rx="8.63158" fill="currentColor" opacity="0.1" />
      {/* Main robot path - filled with current color */}
      <path
    ...
    <defs>
      <clipPath id="clip0_codebuddy">
        <rect width="40" height="40" rx="8.63158" fill="white" />
      </clipPath>
    </defs>
  </svg>
);
