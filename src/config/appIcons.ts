...
import { Bot, Terminal, Sparkles, Code2, Square } from 'lucide-react';
...
export const APP_COLORS: Record<AppType, string> = {
  ...
  'vscode-extension': 'text-blue-600 bg-blue-50 border-blue-200',
};
...
export const APP_DESCRIPTIONS: Record<AppType, string> = {
  ...
  'vscode-extension': 'VS Code Extension - AI coding assistant for VS Code',
};
